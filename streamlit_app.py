    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            for chunk in response:
                ...
                message_placeholder.markdown(full_response + "▌")  # Afficher le texte avec un curseur clignotant

            message_placeholder.markdown(full_response)  # Afficher la réponse finale sans le curseur
